# -*- coding: utf-8 -*-
"""Mistral_Arbiter_Final_model_aware.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1M-heWKuclGun6edlhAiLnrbXEduQY9ct
"""
...
path_mistral_model_aware = "/home/slpl/results/test.model-aware-1500.json"

with open(path_mistral_model_aware, 'r') as istr:
    mistral_data_model_aware = json.load(istr)

path_zephyr_model_aware = "/home/slpl/results/test.model-aware-1500.json"

with open(path_zephyr_model_aware, 'r') as istr:
    zephyr_data_model_aware = json.load(istr)

path_test_model_aware = "/home/slpl/SHROOM_test-unlabeled/test.model-aware.json"
...
zephyr_data_model_aware[0]['zephyr_description']
...
path_val_model_aware_output = "/home/slpl/results/test.model-aware-final-arbiter.json"
...
for i in tqdm.trange(num_sample):
    ...
    zephyr_label = str(zephyr_data_model_aware[i]['zephyr_label'])
    ...
    zephyr_desc = str(zephyr_data_model_aware[i]['zephyr_description'])
