# -*- coding: utf-8 -*-
"""Mistral_Llama2_Zephyr_model_agnostic.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QoV12NiQFDaKp7xYhrDtuJkfN9rC58OF
"""
...
path_mistral_model_agnostic = "/content/drive/MyDrive/sem_eval_task_6/for_zephyr_arbiter/test.model-agnostic-mistral-description.json"

with open(path_mistral_model_agnostic, 'r') as istr:
    mistral_data_model_agnostic = json.load(istr)

path_llama2_model_agnostic = "/content/drive/MyDrive/sem_eval_task_6/for_zephyr_arbiter/test.model-agnostic-llama2-description.json"

with open(path_llama2_model_agnostic, 'r') as istr:
    llama2_data_model_agnostic = json.load(istr)

path_test_model_agnostic = "/content/drive/MyDrive/sem_eval_task_6/test.model-agnostic.json"
...
llama2_data_model_agnostic[0]['description']
...
path_judge_index_model_agnostic_output = "/content/drive/MyDrive/sem_eval_task_6/test.model-agnostic-final-judge_index_1.json"
...
for i in tqdm.trange(num_sample):
    ...
    f = open(path_judge_index_model_agnostic_output, 'w', encoding='utf-8')
